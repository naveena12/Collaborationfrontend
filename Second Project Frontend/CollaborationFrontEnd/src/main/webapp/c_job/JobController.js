...
app.controller('JobController',['$http','$scope','JobService','$location','$rootScope',
                         ...
                         self.submit=function(){
                        	...
                        	self.editJob=function(job){
                        		var container=document.getElementById(job.job_id);
                        	...
                        	self.updateJob=function(job){
                        		...
                        		console.log(job.qualification);
                        		console.log(job.experience);
                        		console.log(job.location);
                        	    console.log(job.vacancy);
                        	    console.log(job.interview_date);
                        	    console.log(job.salary);
                        	    
                        	    if(job.domain && job.qualification &&job.experience){
                        	    	Jobservice.updatejob(job)
                        	    	.then(
                        	    		
                        	    		console.log('list of jobs is updated'),
                        	    	 self.fetchAllJobs,
                        	    		function(errResponse)
                        	    		{
                        	    			console.error('list of jobs is not updated');
                        	    		}
